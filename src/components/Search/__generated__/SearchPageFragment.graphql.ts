...
export type SearchPageFragment$data = {
  ...
  readonly " $fragmentType": "SearchPageFragment";
};
export type SearchPageFragment$key = {
  readonly " $data"?: SearchPageFragment$data;
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./SearchPagePaginationQuery.graphql')
    }
  },
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__SearchPage_fragment_search_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
